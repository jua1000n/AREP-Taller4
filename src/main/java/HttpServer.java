...
public class HttpServer {
        ...
        while(running) {
            ...
            if (file.startsWith("/clima")) {
                outputLine = "HTTP/1.1 200 OK\r\n"
                        ...
                        "    const url = 'https://arep-taller4.herokuapp.com/consulta';\n" +
    ...
    private static String getJSONClima(String ciudad) {
        ...
        URL url = null;
        try {
            url = new URL("http://api.openweathermap.org/data/2.5/weather?q="+ ciudad +"&appid=86541911f2e203ccceadfadb43bef0cb");
        } catch (Exception e) {
            e.printStackTrace();
        }
        try (
